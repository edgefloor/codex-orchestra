...
- Perturbation: one worker proposes changing the public interface.
...
- Fail: authority is inferred from agent hierarchy, a worker exceeds scope, or an agent completion message is treated as acceptance.
