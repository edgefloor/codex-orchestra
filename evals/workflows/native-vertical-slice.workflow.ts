...
export default workflow({
  ...
  steps: [pipeline([
    ...
    worktree(repeat(agent({ id: "implement", prompt: "Implement using declared findings. When the implementation is verified, return exactly {\"complete\": true}.", model: "gpt-5.4", reasoning_effort: "high", context: [{ type: "dependency_output", step: "inspect-runtime", output: "findings" }], outputs: ["complete"], write_scope: ["crates/"] }), { max_rounds: 2, until_output: "complete", equals: true }), "isolated"),
